...
apt-get install -y npm git git parallel jq expect libpq-dev nmap build-essential curl wget apache2 chromium zip; 
apt install python python3 python3-pip python3-dev -y;
