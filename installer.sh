...
apt-get install -y npm git python3 python3-pip python-pip git parallel jq expect libpq-dev python3-dev nmap build-essential curl wget apache2 \
chromium zip; service apache2 start; 
